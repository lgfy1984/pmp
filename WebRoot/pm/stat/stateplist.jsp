	...
	function queryForm(){
		...
		document.form.page.value = 1; 
	 	...
	 	document.form.asc.value = ""; 
	  	...
	  	document.form.verbId.value = "statInit";
	  	document.form.submit();
	}
	//查看详细时候用
	function viewForm(id){
		//alert('${path}/pm/projectstat.do?verbId=statep&createUserId='+id+'&flag=1');
		window.location.href='${path}/pm/projectstat.do?verbId=statep&createUserId='+id+'&flag=1';
	}
