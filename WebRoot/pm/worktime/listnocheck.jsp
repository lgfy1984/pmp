...
//导出客观excel文件
   ...
   function checkall_button(){
		...
		document.form.verbId.value = "deleteNoCheck"; 
...
function query_button(){
 ...
 <form name="form" id="form" method="post" action="projectwork.do">
  <input type="hidden" name="verbId" value="querynocheck" />
		  ...
		  <td style="width:10%">审核状态</td>
			    ...
			    <c:if test='${pb.count<=0}'>
				  ...
				  <tr>
					  ...
					  <td>
					   ...
					   <a href="javascript:void(0)" onclick="showDetail3('${kd.id}')">${kd.projectName}</a>
					   </c:if>
					...
					<tr>
						...
						<td  class='crm_edit_item_content'>
							<input type="text" name="projectClassName" id="projectClassName" class="text"
								onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" readonly
			...
			<div class='crm_button_sub'>
				<input type="button" value="保存" class="button_blue1_s0"
					...
					onclick="saveFormNoCheck('${path}','0','${data.lockStatus}');" />
