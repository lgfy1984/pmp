...
<script type="text/javascript"	src="${path }/style/easyui/jquery.easyui.min.js"></script>
  ...
  <body onload="showHspMessage('${data.message}')" >
		<form name="form" method="post" action= "pm/projectclass.do" >
		
			<input type="hidden" name="verbId" value="update" />
     <input type="hidden" id="itemCodeCase" name="itemCodeCase" value="${data.itemCodeCase}" />
     <input type="hidden" id="itemNameCase" name="itemNameCase" value="${data.itemNameCase}" />
