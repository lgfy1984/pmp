...
$(function () {//esayui验证
	...
	function returnquery(){
	    window.location="projecttask.do?verbId=query";
	}
  ...
  <body onload="showHspMessage('${data.message}')">
  	  <form name="form" id="form" method="post" action="projecttask.do" enctype="multipart/form-data">
      ...
      <div class='crm_edit_panel'>
      	  <table class='crm_panel_table'>
      	  	...
      	  	<tr>
      	  	    <td class='crm_edit_item_name'>项目类别</td>
      	  		<td class='crm_edit_item_content'>
      	  			<input type="text"  class="text" 
      	  				value="${data.projectClassName }" readonly="readonly" /></td>  
      ...
      <div class='crm_button_sub' align="center">
		<input type="button" value="返回" class="button_grey1_s0"
			 ...
			 onmousedown="this.className='button_grey1_s1'" onclick="returnquery();"/>
	  </div>
