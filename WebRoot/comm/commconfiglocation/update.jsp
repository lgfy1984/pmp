...
<html>
	<head>
		...
		%>
		<title><bean:message key="comm.jsp.different.text48" bundle="conf.comm.comm"/></title>
		...
		<script language="javascript">
			function saveForm(){
				...
				if(document.form.levelFlag.value == ""){
				 	alertMessage("0-000002");
				 	return ;
				}
	...
	<body onload="showMessage('','<%=commConfigLocation.getMessage()%>','')">
		<form name="form" method="post" action="comm/commConfigLocation.do">
			<input type="hidden" name="verbId" value="update" />
			<input type="hidden" name="id" value="<%=commConfigLocation.getId()%>" />
			...
			<table align="center" border="0" cellpadding="0" cellspacing="0" class="tblFill" border="0" cellpadding="0" cellspacing="0" class="tblFill">
				<tr>
					<td class="tblTitle" colspan="4"><span>※</span><bean:message key="comm.jsp.different.text48" bundle="conf.comm.comm"/><span>※</span></td>
				</tr>
				<tr>
					<td class="tblLable">
					...
					<td>
						...
						<input type="text" id="parentName" name="parentName" style="width: 225px;" value="<%=commConfigLocation.getParentName()%>"/>
					...
					<td>
						<input type="text"  name="levelFlag" id="levelFlag" size="20" maxlength="9" onkeypress="eventOnKeyPress('itemCode')" value="<%=commConfigLocation.getLevelFlag()%>" />
					</td>
				</tr>
				<tr>
					<td class="tblLable">
				...
				<tr>
					...
					<td>
						<input type="text" name="seqNo" id="seqInLevel" size="20" maxlength="6" onkeypress="eventOnKeyPress('comments')" value="<%=commConfigLocation.getSeqNo()%>" />
					</td>
					<td class="tblLable">
						<bean:message key="comm.jsp.different.text65" bundle="conf.comm.comm"/>：
					</td>
					<td>
						<input type="text"  name="comments" id="address" size="50" maxlength="100" onkeypress="eventOnKeyPress('btnSaveForm')" value="<%=commConfigLocation.getComments()%>" />
					</td>
				</tr>
			</table>
			<div id="searchDiv" style="display:none;">
							<table border="0" width="650" cellspacing="0" cellpadding="0" id="maintable"
								...
								<tr>
									...
									<td  align="left" height="25">
										<input type="text" name="lijian" id="lijian" onkeypress="huiche()" style="width:135px">
									</td>
								</tr>
								<tr>
									<td align="center"  height="25">
							...
							<table align="center" width="650xp">
								<tr align="center">
