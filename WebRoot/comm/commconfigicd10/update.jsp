...
<!--zyc--add--b-->
      	  	...
      	  	<tr>
      	  		...
      	  		<td class='crm_edit_item_content'>
            			...
            			onkeypress="eventOnKeyPress('itemName')" max="32" dataType="LimitB" msg="代码输入过长"
              			value="<%=commConfigIcd10.getItemCode() %>" readonly/>
      	  		</td>
      ...
      <div class='crm_button_sub'>
		<input type="button" value="修改" class="button_blue1_s0" onmouseout="this.className='button_blue1_s0'" onmousedown="this.className='button_blue1_s1'" onclick="saveForm();"/>
