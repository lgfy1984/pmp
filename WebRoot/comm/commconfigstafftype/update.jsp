...
<script type="text/javascript"	src="${path }/style/easyui/jquery.easyui.min.js"></script>
		...
		function saveForm(){
			if(isNaN(document.form.seqNo.value)||trim(document.form.seqNo.value)==""){
				$.messager.alert('提示','<bean:message key="comm.jsp.common.alert1" bundle="conf.comm.Comm"/>'); 
				return true;
			}
			if(document.form.itemCode.value == ""){
			 	$.messager.alert('提示','<bean:message key="comm.jsp.common.notnull" bundle="conf.comm.Comm"/>');
			 	return ;
			}
  ...
  <body onload="showHspMessage('${commConfigStafftype.message}')" >
  	 ...
  	 <input type="hidden" name="itemCodeHidden" id="itemCodeHidden" value="${commConfigStafftype.itemCodeHidden}" />
      	  	...
      	  	<tr>
      	  		...
      	  		<td class='crm_edit_item_content'>
      	  			<input type="text" name="itemName" id="itemName" 
      	  				value="${commConfigStafftype.itemName }" class="text" required="true"  
      	  				onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" 
						onfocus="fEvent('focus',this)" onmouseout="fEvent('mouseout',this)"
      	  	...
      	  	<tr>
      	  		...
      	  		<td class='crm_edit_item_content'>
      	  			<input type="text" name="seqNo" id="seqNo" 
      	  				value="${commConfigStafftype.seqNo }" class="text" 
      	  				onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" 
						onfocus="fEvent('focus',this)" onmouseout="fEvent('mouseout',this)"
      	  		...
      	  		<td class='crm_edit_item_content'>
      	  			<input type="text" name="comments" id="comments" 
      	  				value="${commConfigStafftype.comments }"  class="text" 
      	  				onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" 
						onfocus="fEvent('focus',this)" onmouseout="fEvent('mouseout',this)"
      	  				validtype="length[0,25]" invalidMessage="有效长度0-25"/></td>     	  		
      	  	</tr>
