...
<%}%>
<title><bean:message key="comm.jsp.commconfigunittype.add.title" bundle="conf.comm.CommMessageguoh"/></title>
...
function saveForm(){
	...
	if(isNaN(document.form.seqNo.value)){
		$.messager.alert('提示','<bean:message key="comm.jsp.commconfigunittype.add.saveForm1" bundle="conf.comm.CommMessageguoh"/>'); 
		return true;
	}
...
<body onload="showMessage('','<%=commConfigUnittype.getMessage() %>','1')" >
...
<!--zyc--add--b-->
      	  ...
      	  <table class='crm_panel_table'>
      	  	<tr>
      	  		...
      	  		<td class='crm_edit_item_content'>
      	  			<input type="text" class="text" name="itemCode" size="20" maxlength="8" onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" 
								onfocus="fEvent('focus',this)" onmouseout="fEvent('mouseout',this)" onkeypress="eventOnKeyPress('itemName')" max="32" dataType="LimitB" msg="代码输入过长"  value="<%=commConfigUnittype.getItemCode()%>" />
      	  		</td>
      	  	...
      	  	<tr>
					...
					<input type="text" class="text" name="seqNo"  id="seqNo" size="30" maxlength="20" onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" 
								onfocus="fEvent('focus',this)" onmouseout="fEvent('mouseout',this)" onkeypress="eventOnKeyPress('comments')"  max="11" dataType="LimitB" msg="序号输入过长" value="<%=commConfigUnittype.getSeqNo()%>" />
      	  		</td>      	  	
 ...
 <%--<table  align="center" border="0" cellpadding="0" cellspacing="0" class="tblFill" border="0" cellpadding="0" cellspacing="0" class="tblFill">
    	<tr>
              <td class="tblTitle" colspan="4"><span>※</span> <bean:message key="comm.jsp.commconfigunittype.add.td1" bundle="conf.comm.CommMessageguoh"/> <span>※</span></td>
          </tr>
    <tr>
        <td class="tblLable">
        ...
        <td>
            <input type="text" name="itemCode" size="20" maxlength="9"
                ...
                value="<%=commConfigUnittype.getItemCode() %>" />
        </td>  
        ...
        <td>
            <input type="text"  name="itemName" size="50" maxlength="50"
              ...
              value="<%=commConfigUnittype.getItemName() %>" />
        </td>
    </tr>
    <tr>
        ...
        <td>
            <input type="text"  name="seqNo" id="seqNo" size="30" maxlength="20"
              ...
              value="<%=commConfigUnittype.getSeqNo() %>" />
        </td>
        ...
        <td>
            <input type="text" name="comments" id="comments" size="50" maxlength="20"
        	 onkeypress="eventOnKeyPress('btnSaveForm')" max="40" dataType="LimitB" msg="备注输入过长"
              value="<%=commConfigUnittype.getComments() %>" />
        </td>
    </tr>
