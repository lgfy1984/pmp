...
<jsp:useBean id="data" scope="request" type="com.tianjian.comm.struts.form.CommConfigLocationGroupForm" />
...
<%}%>
<title><bean:message key="comm.jsp.common.jmmessage" bundle="conf.comm.Comm"/>list.jsp</title>
	  ...
	  <div class='crm_table_out'>
		  ...
		  <tbody>
		    <c:if test="${pb.count<=0}">
					...
					<td><%=data.getCommClvNameList()[i]%></td>
