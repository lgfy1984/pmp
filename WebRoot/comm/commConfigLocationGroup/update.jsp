        ...
        onSelect: function(rec){    
            ...
            $('#commClvId').combobox('reload', url);    
      	  	...
      	  	<tr>
      	  		...
      	  		<td class='crm_edit_item_content'>
      	  			<input type="text" class="text" name="itemCode" readonly="readonly" size="20"
							maxlength="32" onkeypress="eventOnKeyPress('itemName')" onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" 
								onfocus="fEvent('focus',this)" onmouseout="fEvent('mouseout',this)"  max="40" dataType="LimitB" msg="代码输入过长"
      	  		...
      	  		<td class='crm_edit_item_content'>
      	  			<input type="text" class="text" name="itemName" size="20"
							maxlength="9"
							onkeypress="eventOnKeyPress('comments')"  onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" 
								onfocus="fEvent('focus',this)" onmouseout="fEvent('mouseout',this)"  max="100" dataType="LimitB" msg="名称输入过长"
