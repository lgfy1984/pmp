...
function saveForm(){
	...
	<body onload="showMessage('','<%=commDictPublicLevel.getMessage()%>','')">
			...
			<table border="0" cellspacing="1" cellpadding="0" class="table">
				<tr>
					<td height="30px" class="biaoti" colspan="4">
						<font color="red">※</font>&nbsp;&nbsp;<bean:message key="Comm.jsp.commom.modifyGeneralDict"bundle="conf.comm.CommMessage"/>&nbsp;&nbsp;
						<font color="red">※</font>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="hou" nowrap>
						<input type="text" class="kuandu" name="seqInLevel" id="seqInLevel" size="20" maxlength="6" onkeypress="eventOnKeyPress('comments')" value="<%=commDictPublicLevel.getSeqInLevel()%>" />
					</td>
				</tr>
				<tr>
					<td class="qian" nowrap>
					...
					<td class="hou" nowrap>
						<input type="text" class="kuandu" name="comments" id="comments" size="50" maxlength="100" onkeypress="eventOnKeyPress('btnSaveForm')" value="<%=commDictPublicLevel.getComments()%>" />
					</td>
					<td class="qian" nowrap>
					</td>
					<td class="hou" nowrap>
