	...
	<body onload="showMessage('','<%=commConfigEconkind.getMessage()%>','1');document.form.commConfigLocationId1.focus();">
		<form name="form" method="post" action="comm/commConfigEconkind.do">
			...
			<!-- <table align="center" border="0" cellpadding="0" cellspacing="0" class="tblFill" border="0" cellpadding="0" cellspacing="0" class="tblFill">
				<tr>
					<td class="tblTitle" colspan="4"><span>※</span> <bean:message  bundle="comm.commLocale" key="comm.jsp.commconfigeconkindadd.text34"/>   <span>※</span></td>
				</tr>
				<tr>
					<td class="tblLable">
					...
					<td>
						<input type="text" name="itemCode" size="20" maxlength="9" onkeypress="eventOnKeyPress('itemName')"  max="32" dataType="LimitB" msg="代码输入过长" value="<%=commConfigEconkind.getItemCode()%>" />
					</td>
					<td class="tblLable">
						<span>*</span> <bean:message  bundle="comm.commLocale" key="comm.jsp.commom.name"/>:
					</td>
					<td>
						<input type="text" name="itemName" size="50" maxlength="50" onkeypress="eventOnKeyPress('seqNo')"  max="40" dataType="LimitB" msg="名称输入过长"  value="<%=commConfigEconkind.getItemName()%>" />
					</td>
				</tr>
				<tr>
					<td class="tblLable">
					...
					<td>
						<input type="text" name="seqNo" id="seqNo" size="30" maxlength="20" onkeypress="eventOnKeyPress('comments')"  max="11" dataType="LimitB" msg="序号输入过长" value="<%=commConfigEconkind.getSeqNo()%>" />
					</td>
					<td class="tblLable">
						<bean:message  bundle="comm.commLocale" key="comm.jsp.commom.comments"/>:
					</td>
					<td>
						<input type="text"  name="comments" id="comments" size="30" maxlength="50" onkeypress="eventOnKeyPress('btnSaveForm')"  max="40" dataType="LimitB" msg="备注输入过长"  value="<%=commConfigEconkind.getComments()%>" />
					</td>
				</tr>
			</table> -->
				...
				<table class='crm_panel_table'>
					<tr>
						...
						<td class='crm_edit_item_content'><input class="text"
							...
							maxlength="32" onkeypress="eventOnKeyPress('itemName')"  max="32" dataType="LimitB" msg="代码输入过长" value="<%=commConfigEconkind.getItemCode()%>"/></td>
					...
					<tr>
						<td class='crm_edit_item_name'><label class="redlable">*</label>序号</td>
      	  				...
      	  				<td class='crm_edit_item_content' colspan="3">
								...
								onfocus="fEvent('focus',this)" onmouseout="fEvent('mouseout',this)" 
							size="20" maxlength="20" value="<%=commConfigEconkind.getComments()%>"  onkeypress="eventOnKeyPress('btnSaveForm')"  max="40" dataType="LimitB" msg="备注输入过长"/> 
      	  				</td>
      	  			</tr>  
				</table>
			</div>
