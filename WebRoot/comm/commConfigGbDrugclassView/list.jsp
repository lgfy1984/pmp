...
function isMadeOf(val,str)
{
	...
	<body onload="showCommMessage('','<%=data.getMessage() %>','1')" >
		...
		<form name="form" method="post"
			action="<%=request.getContextPath()%>/comm/commConfigGbDrugclassView.do">
			<!-- Head line -->
			...
			<!--查询条件-->
			<table width="95%" class="table3" style="font-size: 14px" align="center" border="0"cellspacing="0" cellpadding="0">
				<tr>
					<td id="list_L"></td>
					...
					<td class="button">
						<input type="button"
							...
							name="button" value="<bean:message key="comm.jsp.common.text401" bundle="conf.comm.comm"/>" onClick="submitQueryForm();" />
					</td>
					
				</tr>
			</table>
			<!--列表标题-->
			<table width="95%" align="center" style="font-size: 14px" class="table" border="0"
				...
				<tr class="list_nav">
					...
					<td width="50px">
						<table width="100%"  align="center" border="0" cellpadding="0" cellspacing="0">
							<tr>
								...
								<td align="bottom" height="12">
									<img src="include/images/cmdOrderByAsc.gif" border="0" alt="<bean:message key="comm.jsp.common.text36" bundle="conf.comm.comm"/>"
										style="cursor: hand" onClick="commandOrderBy('5', '0')">
								</td>
							</tr>
							<tr>
								<td height="12">
					...
					<td width="100px">
						<table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
							<tr>
								...
								<td align="bottom" height="12">
									<img src="include/images/cmdOrderByAsc.gif" border="0" alt="<bean:message key="comm.jsp.common.text36" bundle="conf.comm.comm"/>"
										style="cursor: hand" onClick="commandOrderBy('6', '0')">
								</td>
							</tr>
							<tr>
								<td height="12">
					...
					<td width="200px">
						<table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
							<tr>
								<td rowspan="2" align="center">
									<bean:message key="comm.jsp.common.text21" bundle="conf.comm.comm"/>
								</td>
								<td align="bottom" height="12">
									<img src="include/images/cmdOrderByAsc.gif" border="0" alt="<bean:message key="comm.jsp.common.text36" bundle="conf.comm.comm"/>"
										style="cursor: hand" onClick="commandOrderBy('6', '0')">
