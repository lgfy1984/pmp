...
<html>
	<head>
		...
		%>
		<title><bean:message  bundle="comm.comIHE" key="comm.jsp.commIHENameType.update"/></title>
			...
			<table border="0" cellspacing="1" cellpadding="0" class="table">
				<tr>
					<td height="30px" class="biaoti" colspan="4">
						<font color="red">※</font>&nbsp;&nbsp;<bean:message  bundle="comm.comIHE" key="comm.jsp.commIHENameType.update"/>&nbsp;&nbsp;
						<font color="red">※</font>
					</td>
				</tr>
				<tr>
					...
					<td class="hou" nowrap>
						<input type="text" class="kuandu" name="nameTypeCode" size="20" maxlength="16" onkeypress="eventOnKeyPress('itemName')" value="<%=data.getNameTypeCode()%>" readonly/>
					</td>
					<td class="qian" nowrap>
				...
				<tr>
					...
					<td class="hou" nowrap>
						<input type="text" class="kuandu" name="seqNo" id="seqNo" size="20" maxlength="6" onkeypress="eventOnKeyPress('comments')" value="<%=data.getSeqNo()%>" />
					</td>
					<td class="qian" nowrap>
						<bean:message  bundle="comm.comIHE" key="comm.jsp.commIHENameType.segment5"/>:
					</td>
					<td class="hou" nowrap>
						<input type="text" class="kuandu" name="comments" id=""comments"" size="50" maxlength="50" value="<%=data.getComments()%>" onkeypress="eventOnKeyPress('btnSave')"/>
					</td>
				</tr>
			</table>
