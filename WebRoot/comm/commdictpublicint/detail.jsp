...
<jsp:useBean id="commDictPublicInt" scope="request" class="com.tianjian.comm.struts.form.CommDictPublicIntForm" />
		...
		<form name="form" method="post">
			...
			<!-- <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tblView" align="center">
				...
				<tr>
					...
					<td class="hou">
						<%=commDictPublicInt.getDictCode()%>
					</td>
					<td class="tblLable">
						<bean:message key="jsp.dictValue" bundle="conf.Init"/>:
					</td>
					<td class="hou">
						<%=commDictPublicInt.getDictValue()%>
					</td>
				</tr>
				<tr>
					<td class="tblLable">
					...
					<td class="hou">
						<%=commDictPublicInt.getSeqNo()%>
					</td>
					<td class="tblLable">
						<bean:message key="jsp.inputNo" bundle="conf.Init"/>:
					</td>
					<td class="hou">
						<%=commDictPublicInt.getInputCode()%>
					</td>
				</tr>
				<tr>
					<td class="tblLable">
				...
				<table class='crm_panel_table'>
					<tr>
						...
						<td class='crm_edit_item_content'><input onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" 
							...
							value="<%=commDictPublicInt.getId()%>" type="text"
						...
						<td class='crm_edit_item_content'><input id="detail" onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" 
								onfocus="fEvent('focus',this)" onmouseout="fEvent('mouseout',this)" 
							value="<%=commDictPublicInt.getClassName()%>" type="text"
							class="text" readonly="readonly" />
						</td>
					</tr>
					<tr>
						...
						<td class='crm_edit_item_content'><input onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" 
								onfocus="fEvent('focus',this)" onmouseout="fEvent('mouseout',this)" 
							value="<%=commDictPublicInt.getDictCode()%>" type="text"
							class="text" readonly="readonly" />
						</td>
						<td class='crm_edit_item_name'>项目名称</td>
						<td class='crm_edit_item_content'><input onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" 
								onfocus="fEvent('focus',this)" onmouseout="fEvent('mouseout',this)" 
							value="<%=commDictPublicInt.getDictValue()%>" type="text"
							class="text" readonly="readonly" />
						</td>
					</tr>
					<tr>
						...
						<td class='crm_edit_item_content'><input onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" 
								onfocus="fEvent('focus',this)" onmouseout="fEvent('mouseout',this)" 
							value="<%=commDictPublicInt.getSeqNo()%>" type="text"
							class="text" readonly="readonly" />
						</td>
						<td class='crm_edit_item_name'>输入码</td>
						<td class='crm_edit_item_content'><input onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" 
								onfocus="fEvent('focus',this)" onmouseout="fEvent('mouseout',this)" 
							value="<%=commDictPublicInt.getInputCode()%>" type="text"
							class="text" readonly="readonly" />
						</td>
					</tr>
					<tr>
						...
						<td class='crm_edit_item_content'><input onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" 
								onfocus="fEvent('focus',this)" onmouseout="fEvent('mouseout',this)" 
							value="<%=commDictPublicInt.getComments()%>" type="text"
							class="text" readonly="readonly" />
						</td>
					</tr>
				</table>
