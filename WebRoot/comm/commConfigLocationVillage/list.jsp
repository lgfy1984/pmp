...
<jsp:useBean id="data" scope="request" type="com.tianjian.comm.struts.form.CommConfigLocationVillageForm" />
...
<%}%>
<title><bean:message key="comm.jsp.common.checkVillage" bundle="conf.comm.Comm"/>list.jsp</title>
...
<input type="hidden" name="idHidden" value="<%=data.getIdHidden()%>"/>
	  ...
	  <div class='crm_table_out'>
		  ...
		  <thead>
		  <tr>
		  <td style="width:20%">村代码</td>
		  <td style="width:20%">村名称</td>
		  ...
		  <tbody>
		    <c:if test="${pb.count<=0}">
					...
					<td><%=data.getCommCltNameList()[i]%></td>
