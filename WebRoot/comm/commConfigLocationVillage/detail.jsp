...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<%}%>
		<title><bean:message key="comm.jsp.common.td" bundle="conf.comm.Comm"/>detail.jsp</title>
      ...
      <div class='crm_edit_panel'>
      	  <table class='crm_panel_table'>
      	  	...
      	  	<tr>
      	  		...
      	  		<td class='crm_edit_item_content'>
			      <input value="<%= data.getVillagerNum()%>" type="text" onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" 
								onfocus="fEvent('focus',this)" onmouseout="fEvent('mouseout',this)" class="text" readonly="readonly"/>
			    </td>       	  		
      	  		<td class='crm_edit_item_name'>总家庭数</td>
      	  		<td class='crm_edit_item_content'>
			      <input value="<%=data.getFamilyNum() %>" type="text" onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" 
								onfocus="fEvent('focus',this)" onmouseout="fEvent('mouseout',this)" class="text" readonly="readonly"/>
			    </td>       	  		
      	  	</tr>
      	  	<tr>
      	  		...
      	  		<td class='crm_edit_item_content'>
			      <input value="<%=data.getContactPersonName() %>" type="text" onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" 
								onfocus="fEvent('focus',this)" onmouseout="fEvent('mouseout',this)" class="text" readonly="readonly"/>
			    </td>       	  		
      	  		<td class='crm_edit_item_name'>联系电话</td>
      	  		<td class='crm_edit_item_content'>
			      <input value="<%=data.getPhohe() %>" type="text" class="text" onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" 
			...
			<%--<table border="0" cellspacing="1" cellpadding="0" class="table">
				...
				<tr>
					<td class="biaoti" colspan="4" >
						<bean:message key="comm.jsp.common.td" bundle="conf.comm.Comm"/>
					</td>
				</tr>					
				<tr>
					<td class="qian">
				...
				<!--  -->
				<tr>
				  <td class="qian"><bean:message key="comm.jsp.common.totalPerson" bundle="conf.comm.Comm"/>：</td>
				  <td class="hou">
				    <%= data.getVillagerNum()%>
				  </td>
				  <td class="qian"><bean:message key="comm.jsp.common.totalFamily" bundle="conf.comm.Comm"/>：</td>
				  <td class="hou">
				    <%=data.getFamilyNum() %>
				  </td>
				</tr>
				<tr>
				  <td class="qian"><bean:message key="comm.jsp.common.contactPersonName" bundle="conf.comm.Comm"/>：</td>
				  <td class="hou">
				  <%=data.getContactPersonName() %>
				   </td>
				  <td class="qian"><bean:message key="comm.jsp.common.phone" bundle="conf.comm.Comm"/>：</td>
				  <td class="hou">
				  <%=data.getPhohe() %>
				   </td>
				</tr>
