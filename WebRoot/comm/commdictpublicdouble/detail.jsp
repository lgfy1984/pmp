...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css"	href="${path}/style/easyui/themes/icon.css"/>
  		<link rel="stylesheet" type="text/css" href="${path}/style/easyui/themes/default/easyui.css"/>	 <link rel="stylesheet" type="text/css" href="${path}/style/easyuiUpdate.css">
		...
		<form name="form" method="post">
			...
			<!-- <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tblView" align="center">
				...
				<tr>
					...
					<td class="hou">
						<%=commDictPublicDouble.getDictCode()%>
					</td>
					<td class="tblLable">
						<bean:message key="jsp.dictValue" bundle="conf.Init"/>:
					</td>
					<td class="hou">
						<%=commDictPublicDouble.getDictValue()%>
					</td>
				</tr>
				<tr>
					<td class="tblLable">
					...
					<td class="hou">
						<%=commDictPublicDouble.getSeqNo()%>
					</td>
					<td class="tblLable">
						<bean:message key="jsp.inputNo" bundle="conf.Init"/>:
					</td>
					<td class="hou">
						<%=commDictPublicDouble.getInputCode()%>
					</td>
				</tr>
				<tr>
					<td class="tblLable">
					...
					<td class="hou" colspan="3">
						<%=commDictPublicDouble.getComments()%>
					</td>
				</tr>
			</table> -->
				...
				<table class='crm_panel_table'>
					<tr>
						...
						<td class='crm_edit_item_content'><input onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" 
							...
							value="<%=commDictPublicDouble.getId()%>" type="text"
						...
						<td class='crm_edit_item_content'><input id="detail" onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" 
								onfocus="fEvent('focus',this)" onmouseout="fEvent('mouseout',this)" 
							value="<%=commDictPublicDouble.getClassName()%>" type="text"
							class="text" readonly="readonly" />
						</td>
					</tr>
					<tr>
						...
						<td class='crm_edit_item_content'><input onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" 
								onfocus="fEvent('focus',this)" onmouseout="fEvent('mouseout',this)" 
							value="<%=commDictPublicDouble.getDictCode()%>" type="text"
							class="text" readonly="readonly" />
						</td>
						<td class='crm_edit_item_name'>项目名称</td>
						<td class='crm_edit_item_content'><input onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" 
								onfocus="fEvent('focus',this)" onmouseout="fEvent('mouseout',this)" 
							value="<%=commDictPublicDouble.getDictValue()%>" type="text"
							class="text" readonly="readonly" />
						</td>
					</tr>
					<tr>
						...
						<td class='crm_edit_item_content'><input onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" 
								onfocus="fEvent('focus',this)" onmouseout="fEvent('mouseout',this)" 
							value="<%=commDictPublicDouble.getSeqNo()%>" type="text"
							class="text" readonly="readonly" />
						</td>
						<td class='crm_edit_item_name'>输入码</td>
						<td class='crm_edit_item_content'><input onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" 
								onfocus="fEvent('focus',this)" onmouseout="fEvent('mouseout',this)" 
							value="<%=commDictPublicDouble.getInputCode()%>" type="text"
							class="text" readonly="readonly" />
						</td>
					</tr>
					<tr>
						...
						<td class='crm_edit_item_content'><input onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" 
								onfocus="fEvent('focus',this)" onmouseout="fEvent('mouseout',this)" 
							value="<%=commDictPublicDouble.getComments()%>" type="text"
							class="text" readonly="readonly" />
						</td>
					</tr>
				</table>
