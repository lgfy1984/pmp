		...
		<form name="form" method="post" action="comm/commDictPublicDouble.do">
			...
			<div class='crm_search_div' style='overflow: hidden'>
				...
				<div class="crm_input_item">
					...
					<span>项目代码</span>
					<input name="dictCode" class="crm_search_input_text" type="text" onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" 
								onfocus="fEvent('focus',this)" onmouseout="fEvent('mouseout',this)" onkeypress="eventOnKeyPress('itemName')" value="<%=commDictPublicDouble.getDictCode()%>"/>
				</div>
				<div class="crm_input_item">
					<span>项目名称</span>
					<input name="dictValue" class="crm_search_input_text" type="text" onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" 
								onfocus="fEvent('focus',this)" onmouseout="fEvent('mouseout',this)" onkeypress="eventOnKeyPress('inputCode')" value="<%=commDictPublicDouble.getDictValue()%>">
				</div>
				<div class="crm_input_item">
					<span>输入码</span>
					<input name="inputCode" class="crm_search_input_text" style="width:90px" onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" 
								onfocus="fEvent('focus',this)" onmouseout="fEvent('mouseout',this)" type="text" onkeypress="eventOnKeyPress('<bean:message key="jsp.btnsubmit" bundle="conf.Init"/>')" value="<%=commDictPublicDouble.getInputCode()%>">
				</div>
				<div class="crm_input_item">
				...
				<tbody id="interval_row_id">
				  <c:if test="${pb.count<=0}">
					...
					%>
						...
						<td style="cursor:pointer;"><input type="button" class="button_grey2_s0" onmouseout="this.className='button_grey2_s0'" onmousedown="this.className='button_grey2_s1'" value="详细"  onclick="cmdView('<%=commDictPublicDouble.getIdList()[i]%>')"/></td>
						<td style="cursor:pointer;"><input type="button" class="button_grey2_s0" onmouseout="this.className='button_grey2_s0'" onmousedown="this.className='button_grey2_s1'" value="修改"  onclick="cmdEdit('<%=commDictPublicDouble.getIdList()[i]%>')"/></td>
						<td style="cursor:pointer;"><input type="button" class="button_grey2_s0" onmouseout="this.className='button_grey2_s0'" onmousedown="this.className='button_grey2_s1'" value="删除"  onclick="cmdDel('<%=commDictPublicDouble.getIdList()[i]%>')"/></td>
					</tr>
					<%
						}
						}
