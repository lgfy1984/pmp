		...
		<form name="form" method="post" action="comm/commDictPublicDouble.do">
			...
			<!-- <table align="center" border="0" cellpadding="0" cellspacing="0" class="tblFill" border="0" cellpadding="0" cellspacing="0" class="tblFill">
				...
				<tr>
					...
					<td>
						<input type="text" class="kuandu" name="dictCode" size="20" maxlength="9" onkeypress="eventOnKeyPress('dictValue')"  max="20" dataType="LimitB" msg="项目代码输入过长" value="<%=commDictPublicDouble.getDictCode()%>" />
					</td>
				</tr>
				<tr>
					<td class="tblLable">
					...
					<td>
						<input type="text" class="kuandu" name="dictValue" size="50" maxlength="20" onkeypress="eventOnKeyPress('seqNo')" max="20" dataType="LimitB" msg="项目名称输入过长" value="<%=commDictPublicDouble.getDictValue()%>" />
					</td>
					<td class="tblLable">
						<bean:message key="jsp.seqNo" bundle="conf.Init"/>:
					</td>
					<td>
						<input type="text" class="kuandu" name="seqNo" id="seqNo" size="30" maxlength="20" onkeypress="eventOnKeyPress('comments')"   value="<%=commDictPublicDouble.getSeqNo()%>" readonly/>
					</td>
				</tr>
				<tr>
					<td class="tblLable">
