...
<script type="text/javascript" src="http://<%=request.getServerName()%>:<%=request.getServerPort()%><%=request.getContextPath()%>/js/LodopFuncs.js"></script>
		<script language="javascript">
		    ...
		    function print(){
				 var title="婚姻状态字典("+$("table tr td:eq(3) input").val()+")详情";
      	  ...
      	  <table class='crm_panel_table'>
      	  	<tr>
      	  		...
      	  		<td class='crm_edit_item_content'>
      	  		  <input value="<%=commConfigMaritalStatus.getItemCode() %>" type="text" onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" 
								onfocus="fEvent('focus',this)" onmouseout="fEvent('mouseout',this)" class="text" readonly="readonly"/>
      	  		</td>
      	  		<td class='crm_edit_item_name'>名称</td>
      	  		<td class='crm_edit_item_content'>
      	  		  <input value="<%=commConfigMaritalStatus.getItemName() %>" type="text" onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" 
								onfocus="fEvent('focus',this)" onmouseout="fEvent('mouseout',this)" class="text" readonly="readonly">
			    </td>
      	  	</tr>
      	  	<tr>
      	  		...
      	  		<td class='crm_edit_item_content'>
      	  		  <input value="<%=commConfigMaritalStatus.getSeqNo() %> " type="text" onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" 
								onfocus="fEvent('focus',this)" onmouseout="fEvent('mouseout',this)" class="text" readonly="readonly"/>
      	  		</td>
      	  		<td class='crm_edit_item_name'>输入码</td>
      	  		<td class='crm_edit_item_content'>
			      <input value="<%=commConfigMaritalStatus.getInputCode() %>" type="text" onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" 
								onfocus="fEvent('focus',this)" onmouseout="fEvent('mouseout',this)" class="text" readonly="readonly"/>
			    </td>       	  		
      	  	</tr>
      	  	<tr>
      	  		...
      	  		<td class='textArea' colspan="3">
      	  			<textarea class="crm_textarea_style" onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" 
								onfocus="fEvent('focus',this)" onmouseout="fEvent('mouseout',this)" readonly="readonly"><%=commConfigMaritalStatus.getComments() %></textarea>
			    </td>       	  		
      	  	</tr>
      	  </table>
      </div>
			...
			<%--<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tblView" align="center">
				<tr>
					<td class="tblTitle" colspan="4">
						<bean:message key="comm.jsp.common.marryMessage" bundle="conf.comm.Comm"/>
					</td>
				</tr>
				<tr>
					<td class="tblLable">
				...
				<tr>
					...
					<td class="hou">
						<%=commConfigMaritalStatus.getSeqNo()%>
					</td>
					<td class="tblLable">
						<bean:message key="comm.jsp.common.inputItemCode" bundle="conf.comm.Comm"/>:
					</td>
					<td class="hou">
						<%=commConfigMaritalStatus.getInputCode()%>
					</td>
				</tr>
				<tr>
					<td class="tblLable">
					...
					<td class="hou" colspan="3">
						<%=commConfigMaritalStatus.getComments()%>
					</td>
				</tr>
			</table>
