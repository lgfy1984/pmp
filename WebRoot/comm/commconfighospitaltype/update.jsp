...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function saveForm(){
			...
			var itemCode = document.form.itemCode.value;
			var levelCode1 = document.form.levelCode_1.value;
			var levelCode2 = document.form.levelCode_2.value;
			if(levelCode1==itemCode||levelCode2==itemCode){
				$.messager.alert('提示','<bean:message key="comm.jsp.different.text29" bundle="conf.comm.comm"/>!');
				return;
			}
  ...
  <script type="text/javascript" src="${path}/js/default.js"></script>
	...
	<body onload="showHspMessage('<%=data.getMessage() %>')" >
		...
		<input type="hidden" name="levelCode1Hidden" value="<%=data.getLevelCode_1() %>" />
		<input type="hidden" name="levelCode2Hidden" value="<%=data.getLevelCode_2() %>" />
		
		
		<!-- <table align="center" border="0" cellpadding="0" cellspacing="0" class="tblFill" border="0" cellpadding="0" cellspacing="0" class="tblFill">
		    <tr>
		         <td class="tblTitle" colspan="4"><span>※</span><bean:message key="comm.jsp.different.text54" bundle="conf.comm.comm"/><span>※</span></td>
		    </tr>
		     <tr>
		        <td class="tblLable">
		        ...
		        <td>
		            <input type="text" class="kuandu" name="seqNo" id="principal_phone" size="30" maxlength="11"
		        ...
		        <td>
		            <select name="levelCode_1"
						id="levelCode_1"
						onchange="setLevel2('comm/commConfigHospitalType.do')"
		    ...
		    <tr>
		        ...
		        <td>
		         <input type="text" class="kuandu" name="itemCode" id="itemCode" size="20" maxlength="32"
		    ...
		    <tr>
		        ...
		        <td>
		            <input type="text" class="kuandu" name="itemName" id = "itemName" size="50" maxlength="50"
		        ...
		        <td>
		            <input type="text" class="kuandu" name="comments" id="comments" size="30" maxlength="50"
				...
				<table class='crm_panel_table'>
					<tr>
						...
						<td class='crm_edit_item_content'>
							<input type="text" name="seqNo" id="principal_phone"
							 maxlength="11"  class="text" onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" 
								onfocus="fEvent('focus',this)" onmouseout="fEvent('mouseout',this)" 
							onkeypress="eventOnKeyPress('levelCode_1')" max="11"
							dataType="LimitB" msg="序号输入过长" value="<%=data.getSeqNo() %>" />
						</td>
            ...
            $('#levelCode_2').combobox('reload', url);    
					...
					<tr>
						...
						<td class='crm_edit_item_content'>
							...
							msg="代码输入过长" value="<%=data.getItemCode() %>" readonly />
						</td>
					</tr>
					<tr>
