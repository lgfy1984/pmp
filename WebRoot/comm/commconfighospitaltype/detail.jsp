		...
		<form name="form" method="post">
			...
			<!-- <table width="100%" border="0" cellpadding="0" cellspacing="0"
				...
				<tr>
					<td class="tblTitle" colspan="4"><bean:message
							key="comm.jsp.different.text45" bundle="conf.comm.comm" /></td>
				</tr>
				<tr>
					<td class="tblLable"><bean:message key="comm.jsp.common.text10"
							bundle="conf.comm.comm" />:</td>
					<td class="hou"><%=data.getItemCode() %></td>
					<td class="tblLable"><bean:message key="comm.jsp.common.text29"
							bundle="conf.comm.comm" />:</td>
					<td class="hou"><%=data.getItemName() %></td>
				</tr>
				<tr>
					<td class="tblLable"><bean:message
							key="comm.jsp.different.text30" bundle="conf.comm.comm" />:</td>
					<td class="hou"><%=data.getParentItemName() %></td>
					<td class="tblLable"><bean:message
							key="comm.jsp.different.text11" bundle="conf.comm.comm" />:</td>
					<td class="hou"><%=data.getLevelFlag() %></td>
				</tr>
				<tr>
					<td class="tblLable"><bean:message key="comm.jsp.common.text48"
							bundle="conf.comm.comm" />:</td>
					<td class="hou"><%=data.getSeqNo() %></td>
					<td class="tblLable"><bean:message key="comm.jsp.common.text38"
							bundle="conf.comm.comm" />:</td>
					<td class="hou"><%=data.getInputCode() %></td>
				</tr>
				<tr>
					<td class="tblLable"><bean:message key="comm.jsp.common.text4"
							bundle="conf.comm.comm" />:</td>
					<td class="hou" colspan="3"><%=data.getComments() %></td>
				</tr>
			</table> -->
			<div class='crm_edit_panel'>
				<table class='crm_panel_table'>
					...
					<tr>
						<td class='crm_edit_item_name'>所属类</td>
						<td class='crm_edit_item_content'><input onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" 
								onfocus="fEvent('focus',this)" onmouseout="fEvent('mouseout',this)" 
							value="<%=data.getParentItemName() %>" type="text"
							class="text" readonly="readonly" /></td>
						<td class='crm_edit_item_name'>分类级别</td>
						<td class='crm_edit_item_content'><input onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" 
								onfocus="fEvent('focus',this)" onmouseout="fEvent('mouseout',this)" 
							value="<%=data.getLevelFlag() %>" type="text"
							class="text" readonly="readonly"></td>
					</tr>
					<tr>
