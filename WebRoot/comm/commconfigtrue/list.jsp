				...
				<div class="crm_input_item">
					...
					<input class="crm_search_input_text"
						name="inputCode" onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" 
							...
							type="text" value="<%=commConfigTrue.getInputCode()%>" />
				</div>
				<div class="crm_input_item">
				...
				<table style="table-layout: fixed;" class='crm_table_content'>
					...
					<tbody id="interval_row_id">
					   <c:if test="${pb.count<=0}">
						...
						<td style="cursor:pointer;"><input type="button" class="button_grey2_s0" onmouseout="this.className='button_grey2_s0'" onmousedown="this.className='button_grey2_s1'" value="详细"  onclick="cmdView('<%=commConfigTrue.getItemCodeList()[i]%>')"/></td>
						<td style="cursor:pointer;"><input type="button" class="button_grey2_s0" onmouseout="this.className='button_grey2_s0'" onmousedown="this.className='button_grey2_s1'" value="修改"  onclick="cmdEdit('<%=commConfigTrue.getItemCodeList()[i]%>')"/></td>
						<td style="cursor:pointer;"><input type="button" class="button_grey2_s0" onmouseout="this.className='button_grey2_s0'" onmousedown="this.className='button_grey2_s1'" value="删除"  onclick="cmdDel('<%=commConfigTrue.getItemCodeList()[i]%>')"/></td>				
					</tr>
						<%}
					}
