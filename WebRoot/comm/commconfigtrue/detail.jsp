		...
		<!-- <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tblView" align="center">
		 	<tr>
		        <td class="tblTitle" colspan="4">
		          <bean:message key="comm.jsp.commconfigtrue.detail.title" bundle="conf.comm.CommMessageguoh"/>
		        </td>
		    </tr>
		    <tr>
		   		<td class="tblLable">
		           <bean:message key="comm.jsp.commconfigtrue.detail.td1" bundle="conf.comm.CommMessageguoh"/>:
		        </td>
		        <td class="hou">
		            <%=commConfigTrue.getItemCode() %></td>
		        <td class="tblLable">
		            <bean:message key="comm.jsp.commconfigtrue.detail.td2" bundle="conf.comm.CommMessageguoh"/>:
		        </td>
		        <td class="hou">
		        	<%=commConfigTrue.getItemName() %>  
		        </td>
		    ...
		    <tr>
		        ...
		        <td class="hou">            
		             <%=commConfigTrue.getSeqNo() %>      
		        </td>
		        <td class="tblLable">
		            <bean:message key="comm.jsp.commconfigtrue.detail.td4" bundle="conf.comm.CommMessageguoh"/>:
		        </td>
		        <td class="hou">            
		            <%=commConfigTrue.getInputCode() %>  
		        </td>
		    </tr>
		    <tr>
		        <td class="tblLable">
				...
				<table class='crm_panel_table'>
					<tr>
						...
						<td class='crm_edit_item_content'><input onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" 
							...
							value="<%=commConfigTrue.getItemCode()%>" type="text"
						...
						<td class='crm_edit_item_content'><input id="detail" onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" 
								onfocus="fEvent('focus',this)" onmouseout="fEvent('mouseout',this)" 
							value="<%=commConfigTrue.getItemName()%>" type="text"
							class="text" readonly="readonly">
						</td>
					</tr>
					<tr>
						...
						<td class='crm_edit_item_content'><input onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" 
								onfocus="fEvent('focus',this)" onmouseout="fEvent('mouseout',this)" 
							value="<%=commConfigTrue.getInputCode()%>" type="text"
							class="text" readonly="readonly" />
						</td>
						<td class='crm_edit_item_name'>序号</td>
						<td class='crm_edit_item_content'><input onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" 
								onfocus="fEvent('focus',this)" onmouseout="fEvent('mouseout',this)" 
							value="<%=commConfigTrue.getSeqNo()%>" type="text" class="text"
							readonly="readonly" />
						</td>
					</tr>
					...
					<tr>
						...
						<td class='textArea' colspan="3"><textarea onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" 
								onfocus="fEvent('focus',this)" onmouseout="fEvent('mouseout',this)" 
								class="crm_textarea_style" readonly="readonly"><%=commConfigTrue.getComments()%></textarea>
						</td>
					</tr>
				</table>
			</div>
