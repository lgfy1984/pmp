...
<html>
	<head>
		...
		%>
		<title><bean:message  bundle="comm.commLocale" key="comm.jsp.commom.text31"/></title>
...
function saveForm(){
	...
	<body onload="showMessage('','<%=commConfigCardorg.getMessage()%>','')">
			...
			<table border="0" cellspacing="1" cellpadding="0" class="table">
				<tr>
					<td height="30px" class="biaoti" colspan="4">
						<font color="red">※</font>&nbsp;&nbsp;<bean:message  bundle="comm.commLocale" key="comm.jsp.commconfigemptitlelist.text71"/>&nbsp;&nbsp;
						<font color="red">※</font>
					</td>
				</tr>
				<tr>
					...
					<td class="hou" nowrap>
						<input type="text" class="kuandu" name="itemCode" size="20" maxlength="9" onkeypress="eventOnKeyPress('itemName')" value="<%=commConfigCardorg.getItemCode()%>" readonly/>
					</td>
					<td class="qian" nowrap>
				...
				<tr>
					...
					<td class="hou" nowrap>
						<input type="text" class="kuandu" name="seqNo" id="seqNo" size="20" maxlength="6" onkeypress="eventOnKeyPress('comments')" value="<%=commConfigCardorg.getSeqNo()%>" />
					</td>
					<td class="qian" nowrap>
						<bean:message  bundle="comm.commLocale" key="comm.jsp.commom.comments"/>:
					</td>
					<td class="hou" nowrap>
						<input type="text" class="kuandu" name="comments" id="comments" size="50" maxlength="100" onkeypress="eventOnKeyPress('btnSaveForm')" value="<%=commConfigCardorg.getComments()%>" />
					</td>
				</tr>
			</table>
