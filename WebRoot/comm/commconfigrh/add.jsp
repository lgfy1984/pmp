...
<html>
	<head>
		...
		%>
		<title><bean:message key="comm.jsp.commconfigrh.add.title" bundle="conf.comm.CommMessageguoh"/></title>
...
.crm_textarea_style{
	...
	<body onload="showHspMessage('<%=commConfigRh.getMessage()%>')">
...
<!--zyc--add--b-->
      	  ...
      	  <table class='crm_panel_table'>
      	  	<tr>
      	  		...
      	  		<td class='crm_edit_item_content'>
      	  			<input type="text" class="text" name="itemCode" size="20" onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" 
								onfocus="fEvent('focus',this)" onmouseout="fEvent('mouseout',this)" maxlength="8" onkeypress="eventOnKeyPress('itemName')" max="32" dataType="LimitB" msg="代码输入过长"  value="<%=commConfigRh.getItemCode()%>" />
      	  		</td>
      	  	...
      	  	<tr>
					...
					<input type="text" class="text" name="seqNo"  id="seqNo" onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" 
								onfocus="fEvent('focus',this)" onmouseout="fEvent('mouseout',this)" size="30" maxlength="20" onkeypress="eventOnKeyPress('comments')"  max="11" dataType="LimitB" msg="序号输入过长" value="<%=commConfigRh.getSeqNo()%>" />
      	  		</td>      	  	
					...
					<input type="text" class="text" name="comments" id="comments" onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" 
								onfocus="fEvent('focus',this)" onmouseout="fEvent('mouseout',this)" size="30" maxlength="50" value="<%=commConfigRh.getComments()%>" max="40" dataType="LimitB" msg="备注输入过长"  onkeypress="eventOnKeyPress('btnSave')"/>
      	  		</td>
      	  	</tr>      	  	
      	  </table>
      </div>
	 ...
	 <!--zyc--add--e-->
			<%--<table align="center" border="0" cellpadding="0" cellspacing="0" class="tblFill" border="0" cellpadding="0" cellspacing="0" class="tblFill">
				<tr>
					<td class="tblTitle" colspan="4"><span>※</span> <bean:message key="comm.jsp.commconfigrh.add.td1" bundle="conf.comm.CommMessageguoh"/> <span>※</span></td>
				</tr>
				<tr>
					<td class="tblLable">
					...
					<td>
						<input type="text" name="itemCode" size="20" maxlength="9" onkeypress="eventOnKeyPress('itemName')" value="<%=commConfigRh.getItemCode()%>" />
					</td>
					<td class="tblLable">
						<span>*</span> <bean:message key="comm.jsp.commconfigrh.add.td3" bundle="conf.comm.CommMessageguoh"/>
					</td>
					<td>
						<input type="text" name="itemName" size="50" maxlength="20" onkeypress="eventOnKeyPress('seqNo')" value="<%=commConfigRh.getItemName()%>" />
					</td>
				</tr>
				<tr>
					<td class="tblLable">
					...
					<td>
						<input type="text" name="seqNo" id="seqNo" size="30" maxlength="20" onkeypress="eventOnKeyPress('comments')" value="<%=commConfigRh.getSeqNo()%>" />
					</td>
					<td class="tblLable" nowrap>
						<bean:message key="comm.jsp.commconfigrh.add.td5" bundle="conf.comm.CommMessageguoh"/>
					</td>
					<td>
						<input type="text"  name="comments" id="comments" size="30" maxlength="20" onkeypress="eventOnKeyPress('btnSave')" value="<%=commConfigRh.getComments()%>" />
					</td>
				</tr>
			</table>
			<!-- Sheet operation button area -->
			<div class="btnSave">
				<input type="button" id="btnSve" name="btnSave"  name="btnSaveForm" value='<bean:message key="comm.jsp.commconfigrh.add.td6" bundle="conf.comm.CommMessageguoh"/>' onClick="saveForm()" />
				<input type="button" id="btnHistory" name="btnHistory"  name="btnBack" value='<bean:message key="comm.jsp.commconfigrh.add.td7" bundle="conf.comm.CommMessageguoh"/>' onClick="history.go(-1);" />
			</div>
		--%></form>
	</body>
</html>
