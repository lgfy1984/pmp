...
<html>
	<head>
		...
		%>
		<title><bean:message  bundle="comm.comIHE" key="comm.jsp.commIHEAuthority.update"/></title>
...
function saveForm(){
	if(document.form.universalId.value == ""){
	 	alertMessage("0-000001");
	 	return ;
	}
	if(document.form.namespaceId.value == ""){
			...
			<table border="0" cellspacing="1" cellpadding="0" class="table">
				<tr>
					<td height="30px" class="biaoti" colspan="4">
						<font color="red">※</font>&nbsp;&nbsp;<bean:message  bundle="comm.comIHE" key="comm.jsp.commIHEAuthority.update"/>&nbsp;&nbsp;
						<font color="red">※</font>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="hou" nowrap>
						<input type="text" class="kuandu" name="universalIdType" size="20" maxlength="16" onkeypress="eventOnKeyPress('namespaceId')" value="<%=data.getUniversalIdType()%>" readonly/>
					</td>
					<td class="qian" nowrap>
						<bean:message  bundle="comm.comIHE" key="comm.jsp.segment3"/>:
					</td>
					<td class="hou" nowrap>
						<input type="text" class="kuandu" name="namespaceId" id="namespaceId" size="50" maxlength="50" value="<%=data.getNamespaceId()%>" onkeypress="eventOnKeyPress('btnSave')"/>
					</td>
				</tr>
			</table>
