...
function saveForm(){
	...
	<body onload="showMessage('','<%=commConfigDept.getMessage()%>','')">
		<form name="form" method="post" action="comm/commConfigDept.do">
			...
			<table border="0" cellspacing="1" cellpadding="0" class="table">
				...
				<tr>
					...
					<td class="hou" nowrap>
						<input type="text" class="kuandu" name="itemCode" size="20" maxlength="9" onkeypress="eventOnKeyPress('itemName')" value="<%=commConfigDept.getItemCode()%>" readonly/>
					</td>
					<td class="qian" nowrap>
				...
				<tr>
					...
					<td class="hou" nowrap>
						<input type="text" class="kuandu" name="seqNo" id="seqNo" size="20" maxlength="6" onkeypress="eventOnKeyPress('comments')" value="<%=commConfigDept.getSeqNo()%>" />
					</td>
					<td class="qian" nowrap>
						<bean:message  bundle="comm.commLocale" key="comm.jsp.commom.comments"/>:
					</td>
					<td class="hou" nowrap>
						<input type="text" class="kuandu" name="comments" id="comments" size="50" maxlength="100" onkeypress="eventOnKeyPress('btnSaveForm')" value="<%=commConfigDept.getComments()%>" />
					</td>
				</tr>
			</table>
