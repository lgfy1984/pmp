...
<jsp:useBean id="commConfigDepttype" scope="request" class="com.tianjian.comm.struts.form.CommConfigDepttypeForm" />
<html>
	<head>
		<%
		...
		%>
		<title><bean:message  bundle="comm.commLocale" key="comm.jsp.commconfigdepttypeupdate.text59"/></title>
...
function saveForm(){
	...
	<body onload="showMessage('','<%=commConfigDepttype.getMessage()%>','')">
			...
			<table border="0" cellspacing="1" cellpadding="0" class="table">
				<tr>
					<td height="30px" class="biaoti" colspan="4">
						<font color="red">※</font>&nbsp;&nbsp;<bean:message  bundle="comm.commLocale" key="comm.jsp.commconfigdepttypeupdate.text58"/>&nbsp;&nbsp;
						<font color="red">※</font>
					</td>
				</tr>
				<tr>
					...
					<td class="hou" nowrap>
						<input type="text" class="kuandu" name="itemCode" size="20" maxlength="9" onkeypress="eventOnKeyPress('itemName')" value="<%=commConfigDepttype.getItemCode()%>" readonly/>
					</td>
					<td class="qian" nowrap>
						<font color="red">*</font><bean:message  bundle="comm.commLocale" key="comm.jsp.commom.name"/>:
					</td>
					<td class="hou" nowrap>
						<input type="text" class="kuandu" name="itemName" size="50" maxlength="20" onkeypress="eventOnKeyPress('seqNo')" value="<%=commConfigDepttype.getItemName()%>" />
					</td>
				</tr>
				<tr>
					<td class="qian" nowrap>
					...
					<td class="hou" nowrap>
						<input type="text" class="kuandu" name="seqNo" id="seqNo" size="20" maxlength="6" onkeypress="eventOnKeyPress('comments')" value="<%=commConfigDepttype.getSeqNo()%>" />
					</td>
					<td class="qian" nowrap>
						<bean:message  bundle="comm.commLocale" key="comm.jsp.commom.comments"/>:
					</td>
					<td class="hou" nowrap>
						<input type="text" class="kuandu" name="comments" id="comments" size="50" maxlength="20" onkeypress="eventOnKeyPress('btnSaveForm')" value="<%=commConfigDepttype.getComments()%>" />
					</td>
				</tr>
			</table>
