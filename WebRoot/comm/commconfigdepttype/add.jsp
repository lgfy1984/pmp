...
if (confirmMessage("0-000003")){ 
	...
	<body onload="showMessage('','<%=commConfigDepttype.getMessage()%>','1')">
		<form name="form" method="post" action="comm/commConfigDepttype.do">
			...
			<table border="0" cellspacing="1" cellpadding="0" class="table">
				...
				<tr>
					...
					<td class="hou" nowrap>
						<input type="text" class="kuandu" name="itemCode" size="20" maxlength="9" onkeypress="eventOnKeyPress('itemName')" value="<%=commConfigDepttype.getItemCode()%>" />
					</td>
					<td class="qian" nowrap>
				...
				<tr>
					...
					<td class="hou" nowrap>
						<input type="text" class="kuandu" name="seqNo" id="seqNo" size="30" maxlength="20" onkeypress="eventOnKeyPress('comments')" value="<%=commConfigDepttype.getSeqNo()%>" />
					</td>
					<td class="qian" nowrap>
						<bean:message  bundle="comm.commLocale" key="comm.jsp.commom.comments"/>:
					</td>
					<td class="hou" nowrap>
						<input type="text" class="kuandu" name="comments" id="comments" size="30" maxlength="20" onkeypress="eventOnKeyPress('btnSaveForm')" value="<%=commConfigDepttype.getComments()%>" />
					</td>
				</tr>
			</table>
