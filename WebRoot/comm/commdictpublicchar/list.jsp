...
<script type="text/javascript" src="${path}/js/pager.js"></script>
  ...
  <script type="text/javascript" src="${path}/js/default.js"></script>
	...
	<body onload="showHspMessage('<%=commDictPublicChar.getMessage()%>')">
		<!-- Form中的action项的值必须设置-->
		<form name="form" method="post" action="comm/commDictPublicChar.do">
			...
			<!-- <table border="0" cellpadding="0" cellspacing="0" class="tblSearch" align="center">
				...
				<tr>
					<td>
						<bean:message key="Comm.jsp.commom.dictLB" bundle="conf.comm.CommMessage" />:
						<input type="text" class="input" id="displayInputId_1" name="className" style="font-size: 12px; width: 180px" onkeydown="huiche()" value="<%=commDictPublicChar.getClassName()%>" readonly="readonly" onkeypress="eventOnKeyPress('hidden_1')" />
						<input type="hidden" id="hiddenInputId_1" value="<%=commDictPublicChar.getClassCode()%>" name="classCode" />
						<img src="security/include/images/select.gif" style="cursor: pointer;" onclick="add('<%=request.getContextPath()%>/comm/commDictPublicChar.do?verbId=getClass','displayInputId_1','hiddenInputId_1')" />
			...
			<div class='crm_search_div' style='overflow: hidden'>
				<div class="crm_input_item">
					...
					<input type="text" class="crm_search_input_text" id="displayInputId_1"  
							name="className" style="font-size:12px; width:130px;color:black;" 
				...
				<div class="crm_input_item">
					...
					<input name="dictCode" class="crm_search_input_text" onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" 
								onfocus="fEvent('focus',this)" onmouseout="fEvent('mouseout',this)"  type="text" onkeypress="eventOnKeyPress('itemName')" value="<%=commDictPublicChar.getDictCode()%>"/>
				</div>
				<div class="crm_input_item">
					<span>项目名称</span>
					<input name="dictValue" class="crm_search_input_text" onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" 
								onfocus="fEvent('focus',this)" onmouseout="fEvent('mouseout',this)" type="text" onkeypress="eventOnKeyPress('inputCode')" value="<%=commDictPublicChar.getDictValue()%>">
				</div>
				<div class="crm_input_item">
					<span>输入码</span>
					<input name="inputCode" class="crm_search_input_text" onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" 
								onfocus="fEvent('focus',this)" onmouseout="fEvent('mouseout',this)" style="width:90px" type="text" onkeypress="eventOnKeyPress('<bean:message key="jsp.btnsubmit" bundle="conf.Init"/>')" value="<%=commDictPublicChar.getInputCode()%>">
				</div>
				<div class="crm_input_item">
			...
			<table style="table-layout: fixed;" class='crm_table_content'>
				...
				<thead>
			    	<tr class="lstName">
			            ...
			            <th width="15%" height="26"><bean:message key="Comm.jsp.commom.dictLB" bundle="conf.comm.CommMessage" /><div><img src="include/images/cmdOrderByAsc.gif" alt="Ascender" vspace="7" onclick="commandOrderBy('5', '0')" /><img border="0" onclick="commandOrderBy('5', '1')" alt="Descender" src="include/images/cmdOrderByDesc.gif" /></div></th>
				...
				<tbody id="interval_row_id">
				   <c:if test="${pb.count<=0}">
					...
					%>
						...
						<td>
							<%=commDictPublicChar.getClassNameList()[i]%>
						</td>
						<!-- <td>
