...
.crm_textarea_style{
	...
	<body onload="showMessage('','<%=commConfigDegreeLevel.getMessage()%>','')">
		<form name="form" method="post" action="comm/commConfigDegreeLevel.do">
			<input type="hidden" name="verbId" value="update" />
			<input type="hidden" name="itemCodeHidden" value=<%=commConfigDegreeLevel.getItemCodeHidden()%> />
<!--zyc--add--b-->
	 ...
	 <!--zyc--add--e-->
			...
			<%--<table align="center" border="0" cellpadding="0" cellspacing="0" class="tblFill" border="0" cellpadding="0" cellspacing="0" class="tblFill">
				...
				<tr>
					...
					<td class="hou" nowrap>
						<input type="text" class="kuandu" name="itemCode" size="20" maxlength="9" onkeypress="eventOnKeyPress('itemName')"  value="<%=commConfigDegreeLevel.getItemCode()%>" readonly/>
					</td>
					<td class="tblLable" nowrap>
				...
				<tr>
					...
					<td class="hou" nowrap>
						<input type="text" class="kuandu" name="seqNo" id="seqNo" size="20" maxlength="6" onkeypress="eventOnKeyPress('comments')"  max="11" dataType="LimitB" msg="序号输入过长" value="<%=commConfigDegreeLevel.getSeqNo()%>" />
					</td>
					<td class="tblLable" nowrap>
						<bean:message  bundle="comm.commLocale" key="comm.jsp.commom.comments"/>:
					</td>
					<td class="hou" nowrap>
						<input type="text" class="kuandu" name="comments" id="comments" onkeypress="eventOnKeyPress('btnSave')" size="50" maxlength="50"  max="40" dataType="LimitB" msg="备注输入过长" value="<%=commConfigDegreeLevel.getComments()%>" />
					</td>
				</tr>
			</table>
