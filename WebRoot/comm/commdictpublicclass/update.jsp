...
<script type="text/javascript"	src="${path }/style/easyui/jquery.easyui.min.js"></script>
		...
		function saveForm(){
			...
			if(document.form.classCode.value == ""){
			  en(); 
			ymPrompt.$.messager.alert('提示',{message:'<bean:message key="comm.jsp.common.text31" bundle="conf.comm.comm"/>'});
			...
			for(var i=0; i<document.form.seqNo.value.length; i++){
				...
				{
					$.messager.alert('提示','<bean:message key="Comm.js.commom.msg9" bundle="conf.comm.CommMessage"/>');
					return ;
				}
		    } 
				...
				<table class='crm_panel_table'>
					...
					<tr>
						...
						<td class='crm_edit_item_content'><input class="text"
							type="text" class="kuandu" name="seqNo" id="seqNo" onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" 
								onfocus="fEvent('focus',this)" onmouseout="fEvent('mouseout',this)" 
