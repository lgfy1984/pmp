			...
			<!-- <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tblView" align="center">
				<tr>
					<td class="tblTitle" colspan="4">
						<bean:message key="Comm.jsp.commom.dictTypeDetailInfo" bundle="conf.comm.CommMessage"/>
					</td>
				</tr>
				<tr>
					<td class="tblLable">
				...
				<tr>
					...
					<td class="hou">
						<%=commDictPublicClass.getSeqNo()%>
					</td>
					<td class="tblLable">
						<bean:message key="jsp.inputNo" bundle="conf.Init"/>:
					</td>
					<td class="hou">
						<%=commDictPublicClass.getInputCode()%>
					</td>
				</tr>
				<tr>
					<td class="tblLable">
					...
					<td class="hou" colspan="3">
						<%=commDictPublicClass.getComments()%>
					</td>
				</tr>
			</table> -->
				...
				<table class='crm_panel_table'>
					<tr>
						...
						<td class='crm_edit_item_content'><input id="detail" onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" 
								onfocus="fEvent('focus',this)" onmouseout="fEvent('mouseout',this)" 
							value="<%=commDictPublicClass.getClassName()%>" type="text"
							class="text" readonly="readonly">
						</td>
					</tr>
					<tr>
						...
						<td class='crm_edit_item_content'><input onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" 
								onfocus="fEvent('focus',this)" onmouseout="fEvent('mouseout',this)" 
							value="<%=commDictPublicClass.getSeqNo()%>" type="text" class="text"
							readonly="readonly" />
						</td>
						<td class='crm_edit_item_name'>输入码</td>
						<td class='crm_edit_item_content'><input onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" 
								onfocus="fEvent('focus',this)" onmouseout="fEvent('mouseout',this)"  
							value="<%=commDictPublicClass.getInputCode()%>" type="text"
							class="text" readonly="readonly" />
						</td>
					...
					<tr>
						...
						<td class='textArea' colspan="3"><textarea
								...
								onfocus="fEvent('focus',this)" onmouseout="fEvent('mouseout',this)" readonly="readonly"><%=commDictPublicClass.getComments()%></textarea>
						</td>
					</tr>
				</table>
			</div>
