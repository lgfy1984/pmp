		...
		<!-- <table width="100%" border="0" cellpadding="0" cellspacing="0"
			...
			<tr>
				<td class="tblTitle" colspan="4"><bean:message
						key="comm.jsp.commconfigyes.detail.title"
						bundle="conf.comm.CommMessageguoh" /></td>
			</tr>
			<tr>

				<td class="tblLable"><bean:message
						key="comm.jsp.commconfigrh.detail.td2"
						bundle="conf.comm.CommMessageguoh" />:</td>
				<td class="hou"><%=commConfigYes.getItemCode() %></td>
				<td class="tblLable"><bean:message
						key="comm.jsp.commconfigrh.detail.td3"
						bundle="conf.comm.CommMessageguoh" />:</td>
				<td class="hou"><%=commConfigYes.getItemName() %></td>
			</tr>

			<tr>
				<td class="tblLable"><bean:message
						key="comm.jsp.commconfigrh.detail.td4"
						bundle="conf.comm.CommMessageguoh" />:</td>
				<td class="hou"><%=commConfigYes.getSeqNo() %></td>
				<td class="tblLable"><bean:message
						key="comm.jsp.commconfigrh.detail.td5"
						bundle="conf.comm.CommMessageguoh" />:</td>
				<td class="hou"><%=commConfigYes.getInputCode() %></td>
			</tr>
			<tr>
				<td class="tblLable"><bean:message
						key="comm.jsp.commconfigrh.detail.td6"
						bundle="conf.comm.CommMessageguoh" />:</td>
				<td class="hou" colspan="3"><%=commConfigYes.getComments() %></td>
			</tr>
		</table> -->
			...
			<table class='crm_panel_table'>
				<tr>
					...
					<td class='crm_edit_item_content'><input onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" 
						...
						value="<%=commConfigYes.getItemCode()%>" type="text"
					...
					<td class='crm_edit_item_content'><input id="detail" onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" 
								onfocus="fEvent('focus',this)" onmouseout="fEvent('mouseout',this)" 
						value="<%=commConfigYes.getItemName()%>" type="text"
						class="text" readonly="readonly">
					</td>
				</tr>
				<tr>
					...
					<td class='crm_edit_item_content'><input onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" 
								onfocus="fEvent('focus',this)" onmouseout="fEvent('mouseout',this)" 
						value="<%=commConfigYes.getInputCode()%>" type="text"
						class="text" readonly="readonly" />
					</td>
					<td class='crm_edit_item_name'>序号</td>
					<td class='crm_edit_item_content'><input onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" 
								onfocus="fEvent('focus',this)" onmouseout="fEvent('mouseout',this)" 
						value="<%=commConfigYes.getSeqNo()%>" type="text" class="text"
						readonly="readonly" />
					</td>
				</tr>
				...
				<tr>
					...
					<td class='textArea' colspan="3"><textarea onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" 
								onfocus="fEvent('focus',this)" onmouseout="fEvent('mouseout',this)" 
							class="crm_textarea_style" readonly="readonly"><%=commConfigYes.getComments()%></textarea>
					</td>
				</tr>
			</table>
			</div>
