...
<script type="text/javascript"	src="${path }/style/easyui/jquery.easyui.min.js"></script>
	...
	function saveForm(){
		...
		if(isNaN(document.form.seqNo.value)){
			$.messager.alert('提示','<bean:message key="comm.jsp.commconfigyes.add.saveForm1" bundle="conf.comm.CommMessageguoh"/>'); 
			return ;
		}
		...
		if(document.form.itemName.value == ""){
		 	$.messager.alert('提示','<bean:message key="comm.jsp.commconfigyes.add.saveForm3" bundle="conf.comm.CommMessageguoh"/>');
		 	return ;
		}
	...
	<!-- <table border="0" cellpadding="0" cellspacing="0" class="tblFill" border="0" cellpadding="0" cellspacing="0" class="tblFill">
		...
		<div class='crm_button_sub'>
			<input type="button" name="btnSaveForm" value="保存"
				...
				<input
				type="button" name="btnBack" value="返回" class="button_grey1_s0" onmouseout="this.className='button_grey1_s0'" onmousedown="this.className='button_grey1_s1'"
