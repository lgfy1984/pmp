...
function goPage2() {
  ...
  var _total=document.getElementById('_total'); 
    ...
    if (_tp.value<=0){
    	$.messager.alert('提示','<bean:message key="comm.jsp.commconfigrh.list.gopage2_2" bundle="conf.comm.CommMessageguoh"/>');
		return;
    }
...
<body>
		...
		<div class='crm_search_div' style='overflow: hidden'>
		 <div class="crm_input_item">
		  	...
		  	<input class="crm_search_input_text" name="itemCode" type="text" onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" 
								onfocus="fEvent('focus',this)" onmouseout="fEvent('mouseout',this)" onkeypress="eventOnKeyPress('itemName')" value="<%=commConfigVocation.getItemCode()%>" />
		 </div>
		 <div class="crm_input_item">
		  	<span>名称</span>
		  	<input class="crm_search_input_text" name="itemName" type="text" onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" 
								onfocus="fEvent('focus',this)" onmouseout="fEvent('mouseout',this)" onkeypress="eventOnKeyPress('inputCode')" value="<%=commConfigVocation.getItemName() %>" />
		 </div>
		 <div class="crm_input_item">
		  	<span>输入码</span>
		  	<input class="crm_search_input_text" name="inputCode" type="text" onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" 
								onfocus="fEvent('focus',this)" onmouseout="fEvent('mouseout',this)" onkeypress="eventOnKeyPress('btnSave')" value="<%=commConfigVocation.getInputCode() %>" />
		 </div>
		 <div class="crm_input_item">
	  ...
	  <div class='crm_table_out'>
		  ...
		  <tbody>
			...
			<%if (commConfigVocation.getItemCodeList() != null && commConfigVocation.getItemCodeList().length > 0) {
				for (int i = 0; i < commConfigVocation.getItemCodeList().length; i++) {
					...
					<%}
					%>
					<td><%=commConfigVocation.getItemCodeList()[i]%></td>
					<td><%=commConfigVocation.getItemNameList()[i]%></td>
					<td><%=commConfigVocation.getSeqNoList()[i]%></td>
					<td><%=commConfigVocation.getInputCodeList()[i]%></td>
					<td style="cursor:pointer;"><input type="button" class="button_grey2_s0" onmouseout="this.className='button_grey2_s0'" onmousedown="this.className='button_grey2_s1'" value="详细"  onclick="cmdView('<%=commConfigVocation.getItemCodeList()[i] %>')"/></td>
					<td style="cursor:pointer;"><input type="button" class="button_grey2_s0" onmouseout="this.className='button_grey2_s0'" onmousedown="this.className='button_grey2_s1'" value="修改"  onclick="cmdEdit('<%=commConfigVocation.getItemCodeList()[i] %>')"/></td>
					<td style="cursor:pointer;"><input type="button" class="button_grey2_s0" onmouseout="this.className='button_grey2_s0'" onmousedown="this.className='button_grey2_s1'" value="删除"  onclick="cmdDel('<%=commConfigVocation.getItemCodeList()[i] %>')"/></td>
				  </tr>
				<%}
			}
			%>
