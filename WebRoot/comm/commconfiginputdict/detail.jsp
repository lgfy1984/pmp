			...
			<!-- <table width="100%" border="0" cellpadding="0" cellspacing="0"
				...
				<tr>
					<td class="tblTitle" colspan="4"><bean:message
							key="comm.jsp.different.text28" bundle="conf.comm.comm" /></td>
				</tr>
				<tr>
					<td class="tblLable"><bean:message key="comm.jsp.common.text10"
							bundle="conf.comm.comm" /></td>
					<td class="hou"><%=commConfigInputDict.getItemCode() %></td>
					<td class="tblLable"><bean:message key="comm.jsp.common.text29"
							bundle="conf.comm.comm" /></td>
					<td class="hou"><%=commConfigInputDict.getItemName() %></td>
				</tr>
				<tr>
					<td class="tblLable"><bean:message key="comm.jsp.common.text38"
							bundle="conf.comm.comm" /></td>
					<td class="hou"><%=commConfigInputDict.getInputCode() %></td>
					<td class="tblLable"><bean:message key="comm.jsp.common.text45"
							bundle="conf.comm.comm" /></td>
					<td class="hou"><%=commConfigInputDict.getInputCodeWb() %></td>
				</tr>
				<tr>
					<td class="tblLable"><bean:message key="comm.jsp.common.text4"
							bundle="conf.comm.comm" /></td>
					<td class="hou" colspan="3"><%=commConfigInputDict.getComments() %>
					</td>
				</tr>
			</table> -->
				...
				<table class='crm_panel_table'>
					<tr>
						...
						<td class='crm_edit_item_content'><input onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" 
							...
							value="<%=commConfigInputDict.getItemCode()%>" type="text"
						...
						<td class='crm_edit_item_content'><input id="detail" onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" 
								onfocus="fEvent('focus',this)" onmouseout="fEvent('mouseout',this)" 
							value="<%=commConfigInputDict.getItemName()%>" type="text"
							class="text" readonly="readonly">
						</td>
					</tr>
					<tr>
						...
						<td class='crm_edit_item_content'><input onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" 
								onfocus="fEvent('focus',this)" onmouseout="fEvent('mouseout',this)" 
							value="<%=commConfigInputDict.getInputCode()%>" type="text"
							class="text" readonly="readonly" />
						</td>
						<td class='crm_edit_item_name'>五笔码</td>
						<td class='crm_edit_item_content'><input onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" 
								onfocus="fEvent('focus',this)" onmouseout="fEvent('mouseout',this)" 
							value="<%=commConfigInputDict.getInputCodeWb() %>" type="text" class="text"
							readonly="readonly" />
						</td>
					</tr>
					...
					<tr>
						...
						<td class='textArea' colspan="3"><textarea onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" 
								onfocus="fEvent('focus',this)" onmouseout="fEvent('mouseout',this)" 
								class="crm_textarea_style" readonly="readonly"><%=commConfigInputDict.getComments()%></textarea>
						</td>
					</tr>
				</table>
			</div>
