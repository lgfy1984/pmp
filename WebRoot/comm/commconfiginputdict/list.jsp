		...
		<form name="form" method="post" action="comm/commConfigInputDict.do">
				...
				<div class="crm_input_item">
					...
					<input class="crm_search_input_text"
						name="inputCode" onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" 
							...
							type="text" value="<%=commConfigInputDict.getInputCode()%>" />
				</div>
				<div class="crm_input_item">
					<span>五笔码</span> 
					<input class="crm_search_input_text" onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" 
								onfocus="fEvent('focus',this)" onmouseout="fEvent('mouseout',this)" 
						name="inputCodeWb" type="text"  onkeypress="eventOnKeyPress('btnsubmit')"
			...
			<table style="table-layout: fixed;" class='crm_table_content'>
				...
				%>
					...
					<td style="cursor:pointer;"><input type="button" class="button_grey2_s0" onmouseout="this.className='button_grey2_s0'" onmousedown="this.className='button_grey2_s1'" value="详细"  onclick="cmdView('<%=commConfigInputDict.getItemCodeList()[i] %>')"/></td>
						<td style="cursor:pointer;"><input type="button" class="button_grey2_s0" onmouseout="this.className='button_grey2_s0'" onmousedown="this.className='button_grey2_s1'" value="修改"  onclick="cmdEdit('<%=commConfigInputDict.getItemCodeList()[i] %>')"/></td>
						<td style="cursor:pointer;"><input type="button" class="button_grey2_s0" onmouseout="this.className='button_grey2_s0'" onmousedown="this.className='button_grey2_s1'" value="删除"  onclick="cmdDel('<%=commConfigInputDict.getItemCodeList()[i] %>')"/></td>			
				</tr>
					<%
						}
					}
