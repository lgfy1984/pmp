...
$(function () {//esayui验证
	...
	function returnStafftype(){
	    window.location="${path}/comm/commConfigStaffCharge.do?verbId=query";
	}
  ...
  <body onload="showHspMessage('${data.message}')">
  	  <form name="form" id="form" method="post" action="commConfigStaffCharge.do" enctype="multipart/form-data">
      ...
      <div class='crm_edit_panel'>
      	  <table class='crm_panel_table'>
      	  	<tr>
      	  		...
      	  		<td class='crm_edit_item_content'>
      	  			<input type="text" name="itemCode" id="itemCode" 
      	  				value="${data.itemCode }" readonly="readonly" 
      	  		...
      	  		<td class='crm_edit_item_content'>
      	  			<input type="text" name="itemName" id="itemName" 
      	  				value="${data.itemName }" readonly="readonly"  
      	  				onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" 
						onfocus="fEvent('focus',this)" onmouseout="fEvent('mouseout',this)"
      	  	...
      	  	<tr>
      	  		<td class='crm_edit_item_name'>成本</td>
      	  		<td class='crm_edit_item_content'>
      	  			<input type="text" name="itemCost" id="itemCost" 
      	  				value="${data.itemCost }" readonly="readonly" 
      	  				onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" 
						onfocus="fEvent('focus',this)" onmouseout="fEvent('mouseout',this)"
      	  				class="text" required="true" /></td>
      	  		<td class='crm_edit_item_name'>单位</td>
      	  		<td class='crm_edit_item_content'>
      	  			<input type="text" name="itemUnit" id="itemUnit" 
      	  				value="${data.itemUnit }" readonly="readonly"  
      	  				onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" 
						onfocus="fEvent('focus',this)" onmouseout="fEvent('mouseout',this)"
      	  				class="text" required="true"  validtype="length[1,40]" invalidMessage="有效长度1-40"/></td>
      	  	...
      	  	<tr>
      	  		...
      	  		<td class='crm_edit_item_content'>
      	  			<input type="text" name="seqNo" id="seqNo" 
      	  				value="${data.seqNo }"  readonly="readonly" 
      	  				onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" 
						onfocus="fEvent('focus',this)" onmouseout="fEvent('mouseout',this)"
      	  		...
      	  		<td class='crm_edit_item_content'>
      	  			<input type="text" name="comments" id="comments" 
      	  				value="${data.comments }" readonly="readonly" 
      	  				onblur="fEvent('blur',this)" onmouseover="fEvent('mouseover',this)" 
						onfocus="fEvent('focus',this)" onmouseout="fEvent('mouseout',this)"
						class="text" validtype="length[0,25]" invalidMessage="有效长度0-25"/></td>     	  		
      	  	</tr>
