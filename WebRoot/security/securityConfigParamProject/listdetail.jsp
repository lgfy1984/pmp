			...
			<table class='crm_table_content'>
				...
				<tbody id="interval_row_id">
					...
					<tr>
						...
						<td>
						<input type="button" class="button_grey2_s0" onmouseout="this.className='button_grey2_s0'" onmousedown="this.className='button_grey2_s1'" value="详细" onClick="cmdView('<%=data.getProjectCodeList()[i] %>')">
						</td>
					</tr>
					<%
						}
