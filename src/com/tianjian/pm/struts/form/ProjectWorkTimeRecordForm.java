 ...
 * 
 */
public class ProjectWorkTimeRecordForm  extends ActionForm  {
	...
	*/ 
	...
	public List<ProjectWorkVo> getPwv() {
		return pwv;
	}
	public void setPwv(List<ProjectWorkVo> pwv) {
		this.pwv = pwv;
	}
	public String getId() {
		return id;
