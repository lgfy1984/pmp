...
import com.tianjian.comm.business.ICommConfigVipService;
...
public class CommConfigVipAction extends BaseAction {

	private ICommConfigVipService commConfigVipService;
	...
	public ICommConfigVipService getCommConfigVipService() {
		return commConfigVipService;
	}

	public void setCommConfigVipService(ICommConfigVipService commConfigVipService) {
		this.commConfigVipService = commConfigVipService;
	}
	...
	public ActionForward add(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		try {
			CommConfigSexForm hosform = (CommConfigSexForm) form;
			CommConfigVip checkData = commConfigVipService.checkData(hosform.getItemCode());
			if (checkData != null) {
				...
				commConfigVipService.addInit(hosform);
			...
			commConfigVipService.save(hosform);
			CommConfigSexForm hosformNew = new CommConfigSexForm();
	...
	public ActionForward init(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		try {
			String verbId = request.getParameter("verbId");
			CommConfigSexForm ssform = (CommConfigSexForm) form;
			request.setAttribute("commConfigSex", ssform);
	...
	public ActionForward query(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		try {
			...
			int count;
			int page = 0;
			int recordCount = commConfigVipService.getCount(hosform.getItemCode(), hosform.getItemName(), hosform.getInputCode(), hosform.getSeqNo());
			...
			// ////// page end ////////////////////////
			commConfigVipService.getSearch(hosform, count, pageSize);
			commConfigVipService.serchInit(hosform);
			request.setAttribute("commConfigSex", hosform);
	...
	public ActionForward updateInit(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		try {
			CommConfigSexForm hosform = (CommConfigSexForm) form;
			commConfigVipService.updateInit(hosform);
			request.setAttribute("commConfigSex", hosform);
	...
	public ActionForward addInit(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		try {
			CommConfigSexForm hosform = new CommConfigSexForm();
			commConfigVipService.addInit(hosform);
			request.setAttribute("commConfigSex", hosform);
			return mapping.findForward("add");
		}
	...
	public ActionForward detail(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		try {
			CommConfigSexForm hosform = (CommConfigSexForm) form;
			commConfigVipService.showInit(hosform);
			request.setAttribute("commConfigSex", hosform);
	...
	public ActionForward update(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		try {
			CommConfigSexForm hosform = (CommConfigSexForm) form;
			hosform.setInputCode(commConfigInputDictService.getInputCode(hosform.getItemName()));
			commConfigVipService.update(hosform);
			CommConfigSexForm hosformNew = new CommConfigSexForm();
			return this.query(mapping, hosformNew, request, response);
		}
		catch (Exception e) {
	...
	public ActionForward delete(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		try {
			CommConfigSexForm hosform = (CommConfigSexForm) form;
			commConfigVipService.delete(hosform);
