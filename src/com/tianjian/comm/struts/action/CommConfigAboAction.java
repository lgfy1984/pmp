...
public class CommConfigAboAction extends BaseAction {

	private ICommConfigAboService commConfigAboService;
	...
	public ICommConfigAboService getCommConfigAboService() {
		return commConfigAboService;
	}

	public void setCommConfigAboService(ICommConfigAboService commConfigAboService) {
		this.commConfigAboService = commConfigAboService;
	}
	...
	public ActionForward add(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		try {
			CommConfigAboForm hosform = (CommConfigAboForm) form;
			...
			commConfigAboService.save(hosform);
			CommConfigAboForm hosformNew = new CommConfigAboForm();
	...
	public ActionForward init(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		try {
			String verbId = request.getParameter("verbId");
			CommConfigAboForm ssform = (CommConfigAboForm) form;
			request.setAttribute("commConfigAbo", ssform);
	...
	public ActionForward query(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		try {
			...
			int count;
			int page = 0;
			int recordCount = commConfigAboService.getCount(hosform.getItemCode(), hosform.getItemName(), hosform.getInputCode(), hosform.getSeqNo());
			...
			// ////// page end ////////////////////////
			commConfigAboService.getSearch(hosform, count, pageSize);
			commConfigAboService.serchInit(hosform);
			request.setAttribute("commConfigAbo", hosform);
	...
	public ActionForward updateInit(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		try {
			...
			commConfigAboService.updateInit(hosform);
			request.setAttribute("commConfigAbo", hosform);
	...
	public ActionForward addInit(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		try {
			CommConfigAboForm hosform = new CommConfigAboForm();
			commConfigAboService.addInit(hosform);
			request.setAttribute("commConfigAbo", hosform);
			return mapping.findForward("add");
		}
	...
	public ActionForward update(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		try {
			CommConfigAboForm hosform = (CommConfigAboForm) form;
			hosform.setInputCode(commConfigInputDictService.getInputCode(hosform.getItemName()));
			commConfigAboService.update(hosform);
			CommConfigAboForm hosformNew = new CommConfigAboForm();
			return this.query(mapping, hosformNew, request, response);
		}
		catch (Exception e) {
	...
	public ActionForward delete(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		try {
			CommConfigAboForm hosform = (CommConfigAboForm) form;
			commConfigAboService.delete(hosform);
