...
public class CommConfigEmptitleAction extends BaseAction {

	private ICommConfigEmptitleService commConfigEmptitleService;
	...
	public ICommConfigEmptitleService getCommConfigEmptitleService() {
		return commConfigEmptitleService;
	}

	public void setCommConfigEmptitleService(ICommConfigEmptitleService commConfigEmptitleService) {
		this.commConfigEmptitleService = commConfigEmptitleService;
	}
	...
	public ActionForward add(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		try {
			CommConfigEmptitleForm hosform = (CommConfigEmptitleForm) form;
			CommConfigEmptitle checkData = commConfigEmptitleService.checkData(hosform.getItemCode());
			if (checkData != null) {
				...
				commConfigEmptitleService.addInit(hosform);
				request.setAttribute("commConfigEmptitle", hosform);
				return mapping.findForward("add");
			}
			hosform.setInputCode(commConfigInputDictService.getInputCode(hosform.getItemName()));
			commConfigEmptitleService.save(hosform);
			CommConfigEmptitleForm hosformNew = new CommConfigEmptitleForm();
	...
	public ActionForward query(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		try {
			...
			int count;
			int page = 0;
			int recordCount = commConfigEmptitleService.getCount(hosform.getItemCode(), hosform.getItemName(), hosform.getInputCode(), hosform.getSeqNo());
			...
			// ////// page end ////////////////////////
			commConfigEmptitleService.getSearch(hosform, count, pageSize);
			commConfigEmptitleService.serchInit(hosform);
			request.setAttribute("commConfigEmptitle", hosform);
	...
	public ActionForward updateInit(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		try {
			CommConfigEmptitleForm hosform = (CommConfigEmptitleForm) form;
			commConfigEmptitleService.updateInit(hosform);
			request.setAttribute("commConfigEmptitle", hosform);
	...
	public ActionForward addInit(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		try {
			CommConfigEmptitleForm hosform = new CommConfigEmptitleForm();
			commConfigEmptitleService.addInit(hosform);
			request.setAttribute("commConfigEmptitle", hosform);
			return mapping.findForward("add");
		}
	...
	public ActionForward detail(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		try {
			CommConfigEmptitleForm hosform = (CommConfigEmptitleForm) form;
			commConfigEmptitleService.showInit(hosform);
			request.setAttribute("commConfigEmptitle", hosform);
	...
	public ActionForward update(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		try {
			CommConfigEmptitleForm hosform = (CommConfigEmptitleForm) form;
			hosform.setInputCode(commConfigInputDictService.getInputCode(hosform.getItemName()));
			commConfigEmptitleService.update(hosform);
			CommConfigEmptitleForm hosformNew = new CommConfigEmptitleForm();
			return this.query(mapping, hosformNew, request, response);
		}
		catch (Exception e) {
	...
	public ActionForward delete(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		try {
			CommConfigEmptitleForm hosform = (CommConfigEmptitleForm) form;
			commConfigEmptitleService.delete(hosform);
